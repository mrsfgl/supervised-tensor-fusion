...
%-----------------------------------------------------------------------
clear matlabbatch
group_dir = 'D:\Research\Visual_Auditory_Processed\group_level_auditory';
mkdir(group_dir);
...
for s = 1 : nsub
    ...
    dname = fullfile(data_dir, sprintf('sub-%s\\auditory_first_level', subs{s}));
...
cd('D:\Research\Visual_Auditory_Processed\group_level_auditory');
