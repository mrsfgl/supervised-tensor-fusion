function A = acmtf_vec_to_struct_sc(x, Z, R)
% ACMTF_VEC_TO_STRUCT_CS Converts a vector to a struct similar to
% ACMTF_VEC_TO_STRUCT for soft coupled ACMTF.
% 
% A = ACMTF_VEC_STRUCT_SC(x, Z, R)
%
% Input:  x: a vector of P, where for an I by J by K tensor and I by L
%            matrix, P = (I+J+K+I+L+2)*R and R is the number of components.
...
%
% See also ACMTF_VEC_TO_STRUCT, ACMTF_FUN, ACMTF_STRUCT_TO_VEC, CMTF_CHECK.
%
