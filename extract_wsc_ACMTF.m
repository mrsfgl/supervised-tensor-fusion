function [Zhat, out]=extract_wsc_ACMTF(I1, I2, R, beta_cp, beta_pca)
%EXTRACT_WSC_ACMTF
%
...
init = 'random';
% fit ACMTF-OPT
[Zhat,~,out] = acmtf_opt_wsc(Z,R,'init',init,'alg_options',options, 'beta_cp', beta_cp, 'beta_pca', beta_pca); 
