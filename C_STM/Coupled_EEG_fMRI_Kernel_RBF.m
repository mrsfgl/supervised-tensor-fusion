...
%                 val = TensorKernel_RBF(U1, U2, [gammaU,gammaC,gammaV]);
                val = 0 * TensorKernel_RBF(Tx1{1}.U(3), Tx2{1}.U(3), gammaC) +...
                    0 * TensorKernel_RBF(Tx1{1}.U(1:2), Tx2{1}.U(1:2), gammaU) +...
                    1 * TensorKernel_RBF(Tx1{2}.U(1:end-1), Tx2{2}.U(1:end-1), gammaV);
            else
                if length(Tx1.U)==4
%                     val = TensorKernel_RBF(Tx1.U, Tx2.U, [gammaU,gammaC,gammaV]);
                    val = 0 * TensorKernel_RBF(Tx1.U(1:2), Tx2.U(1:2), gammaU) +...
                        0 * TensorKernel_RBF(Tx1.U(3), Tx2.U(3), gammaC) +...
                        1 * TensorKernel_RBF(Tx1.U(4), Tx2.U(4), gammaV);
                elseif length(Tx1.U)==5
                    val = 0.2 * TensorKernel_RBF(Tx1.U(1), Tx2.U(1), gammaC) +...
                        0.8 * TensorKernel_RBF(Tx1.U(2:5), Tx2.U(2:5), [gammaU,gammaV]);
                else
